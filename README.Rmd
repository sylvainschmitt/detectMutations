...
library(vroom)
library(csv2sql)
mutations <- lapply(list.files("results/mutations_tsv2/", full.names = T), vroom, 
                    col_types = cols(
                      .default = col_double(),
                      CHROM = col_character(),
                      ID = col_logical(),
...
vroom_write(mutations, path = "results/mutations_strelka2_2.csv", delim = ",")
rm(mutations)
unlink("results/mutations_strelka2_2.sql")
csv_to_sqlite(csv_name = "results/mutations_strelka2_2.csv", 
              db_name = "results/mutations_strelka2_2.sql", 
              table_name = "mutations")
unlink("results/mutations_strelka2_2.csv")
```
