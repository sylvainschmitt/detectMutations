tsvin <- snakemake@input[[1]] # "results/napoleon/napoleon_mutations.tsv"
psl <-  snakemake@input[[2]] # "results/napoleon/napoleon_mutations.psl"
tsvout <-  snakemake@output[[1]] # "results/napoleon_mutations.tsv"

# Manual
# tsvin <- "results/napoleon/napoleon_mutations.tsv"
# psl <-  "results/napoleon/napoleon_mutations.psl"
# tsvout <-  "results/napoleon_mutations.tsv"
